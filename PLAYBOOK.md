# Valarions Claude Local Agent Playbook

This playbook is a practical guide to run Valarions Claude with a local model (Ollama), work safely, and get strong day-to-day results.
...
If everything is healthy, Valarions Claude starts directly.
...
Or let Valarions Claude recommend the best local model for your goal:
...
- Keep any legacy workspace `.oc-profile.json` local; new provider saves use the user config directory.
