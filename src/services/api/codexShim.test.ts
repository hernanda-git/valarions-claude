...
describe('Codex request translation', () => {
  ...
  test('recovers Codex web search text and sources from sparse completed response', () => {
    const output = webSearchToolTest.makeOutputFromCodexWebSearchResponse(
        ...
        output: [
          {
            ...
            sources: [
              {
                title: 'Valarions Claude repo',
                url: 'https://github.com/example/oc',
              },
            ],
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Valarions Claude is available on GitHub.',
                sources: [
                  {
                    title: 'Docs',
                    url: 'https://docs.example.com/oc',
                  },
                ],
              },
            ],
      ...
      'Valarions Claude GitHub 2026',
      0.42,
    )

    expect(output.results).toEqual([
      'Valarions Claude is available on GitHub.',
      {
            ...
            content: [
              {
                ...
                sources: [
                  { title: 'Docs', url: 'https://docs.example.com/oc' },
                ],
              },
            ],
          },
  ...
  test('Codex stream: tool args delivered only via function_call_arguments.done (#1259)', async () => {
    const args = '{"path":"./oc-codex-repro","pattern":"**/*.md"}'
    const responseText = [
      'event: response.output_item.added',
