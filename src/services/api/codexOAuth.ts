...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Valarions Claude now.</p>
    <p>Valarions Claude will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Valarions Claude.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Valarions Claude.</p>
  </body>
</html>`
}
