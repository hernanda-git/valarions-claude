...
function buildSchemaTemplate(projectName: string): string {
  return `# Valarions Claude Wiki Schema
...
This wiki is maintained by Valarions Claude as a durable project knowledge layer.
...
- ${timestamp}: Wiki initialized by Valarions Claude
`
}
