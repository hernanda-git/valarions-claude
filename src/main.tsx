...
async function run(): Promise<CommanderCommand> {
  ...
  program.name('oc').description(`OpenClaude - starts an interactive session by default, use -p/--print for non-interactive output`).argument('[prompt]', 'Your prompt', String)
  ...
  }).version(`${MACRO.DISPLAY_VERSION ?? MACRO.VERSION} (Hernanda Agent)`, '-v, --version', 'Output the version number');
