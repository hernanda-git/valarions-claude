...
mock.module('../config.js', () => ({
  ...
  getManagedClaudeRulesDir: () => '/tmp/oc-managed-rules',
  getMemoryPath: () => '/tmp/oc-memory.md',
  getOrCreateUserID: () => 'test-user-id',
  getProjectPathForConfig: () => '/tmp/oc-project-config.json',
  getRemoteControlAtStartup: () => false,
  getUserClaudeRulesDir: () => '/tmp/oc-user-rules',
...
mock.module('./marketplaceManager.js', () => ({
  ...
  getMarketplacesCacheDir: () => '/tmp/oc-marketplaces',
  ...
  test('uses known marketplaces as the installed source of truth', async () => {
    knownMarketplaces = {
      'claude-plugins-official': {
        installLocation: '/tmp/oc-marketplaces/claude-plugins-official',
      },
    }
