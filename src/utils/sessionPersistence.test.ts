...
describe('sessionPersistence', () => {
  const testSessionDir = join(process.env.TEMP_DIR ?? '/tmp', 'oc-test-sessions')

  beforeEach(async () => {
    process.env.OC_TEST_SESSIONS_DIR = testSessionDir
  ...
  afterEach(() => {
    delete process.env.OC_TEST_SESSIONS_DIR
  })
