...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/oc.proto')
...
async function main() {
  ...
  const client = new ocProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mValarions Claude gRPC CLI\x1b[0m')
