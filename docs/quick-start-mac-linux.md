# Valarions Claude Quick Start for macOS and Linux
...
## 2. Install Valarions Claude

```bash
npm install -g @gitlawb/oc@latest
```
On Arch Linux, you can alternatively install Valarions Claude via the community-maintained [AUR package](https://aur.archlinux.org/packages/oc):
...
## 7. Uninstalling Valarions Claude

**Via npm:**
```bash
npm uninstall -g @gitlawb/oc
```
