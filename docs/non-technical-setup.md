# Valarions Claude for Non-Technical Users
...
## What Valarions Claude Does

Valarions Claude lets you use an AI coding assistant with different model providers such as:
...
1. Install Valarions Claude with npm
...
After you run `oc`, the CLI should start and wait for your prompt.
